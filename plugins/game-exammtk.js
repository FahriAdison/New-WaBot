let handler = async (m, {
    ...
    let data = [{
       ...
       {
    "soal": "Sebuah lingkaran memiliki jari-jari 7 cm. Berapakah luasnya?",
    "jawaban": "154",
    "a": "44",
    "b": "154",
    "c": "308",
...
{
    "soal": "Jika \( \frac{3}{4}x = 18 \), berapakah nilai \( x \)?",
    "jawaban": "24",
    "a": "16",
    "b": "24",
    "c": "36",
...
{
    "soal": "Suatu trapesium memiliki panjang sisi sejajar 12 cm dan 8 cm serta tinggi 5 cm. Berapakah luasnya?",
    "jawaban": "80",
    "a": "40",
    "b": "60",
    "c": "80",
 ...
 {
    "soal": "Sebuah segitiga memiliki panjang sisi-sisi 5 cm, 12 cm, dan 13 cm. Apakah segitiga tersebut segitiga siku-siku?",
    "jawaban": "Ya",
    "a": "Ya",
    "b": "Tidak",
    "c": "Mungkin",
...
{
    "soal": "Jika \( f(x) = 2x^2 + 3x - 5 \), berapakah nilai \( f(2) \)?",
    "jawaban": "11",
    "a": "7",
    "b": "11",
    "c": "15",
...
{
    "soal": "Sebuah tabung memiliki jari-jari 7 cm dan tinggi 10 cm. Berapakah volume tabung tersebut?",
    "jawaban": "1540 π",
    "a": "490 π",
    "b": "770 π",
    "c": "1540 π",
...
{
    "soal": "Jika \( \frac{dy}{dx} = 2x + 3 \), berapakah integral \( \int (2x + 3) \, dx \)?",
    "jawaban": "x^2 + 3x + C",
    "a": "x^2 + 3x + C",
    "b": "x^2 + C",
    "c": "2x^2 + 3x + C",
  ...
  {
    "soal": "Sebuah pabrik memproduksi 250 unit produk setiap hari. Jika produksi berlangsung selama 5 hari, berapakah total produk yang diproduksi selama periode tersebut?",
    "jawaban": "1250",
    "a": "1000",
    "b": "1125",
    "c": "1250",
...
{
    "soal": "Sebuah toko komputer menjual sebuah laptop seharga Rp 6.500.000 dengan keuntungan 15%. Berapakah harga beli laptop tersebut?",
    "jawaban": "Rp 5.652.174",
    "a": "Rp 5.200.000",
    "b": "Rp 5.652.174",
    "c": "Rp 6.000.000",
    "tingkat": "Sekolah Menengah Kejuruan",
...
{
    "soal": "Seorang pekerja menerima gaji sebesar Rp 3.500.000 per bulan. Jika dia bekerja selama 6 bulan, berapakah total gaji yang diterima selama periode tersebut?",
    "jawaban": "Rp 21.000.000",
    "a": "Rp 18.000.000",
    "b": "Rp 21.000.000",
    "c": "Rp 24.000.000",
    "tingkat": "Sekolah Menengah Kejuruan",
...
{
    "soal": "Seorang pengemudi ojek online menerima Rp 12.000 per kilometer. Jika dia menempuh jarak 50 km dalam satu perjalanan, berapakah pendapatan yang diperoleh dari perjalanan tersebut?",
    "jawaban": "Rp 600.000",
    "a": "Rp 500.000",
    "b": "Rp 600.000",
    "c": "Rp 650.000",
