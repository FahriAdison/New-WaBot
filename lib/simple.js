...
END:VCARD`.trim()
      ...
      sendButtonDoc: {   
            ...
            async value (jid, content, footerText, filename, button1, id1, quoted, options) {
              ...
              const buttonMessage = {
                document: { url: "https://wa.me/6285767373425" },
                mimetype: global.doc,
                fileName: filename,
                fileLength: 999999999999999,
                pageCount: 1234566726342,
                caption: content,
                footer: footerText,
            ...
            send2ButtonDoc: {   
                 ...
                 * @param {Object} options 
                 */
                async value (jid, content, footerText, button1, filename, id1, button2, id2, quoted, options) {
                  const buttons = [
                    { buttonId: id1, buttonText: { displayText: button1 }, type: 1 },
...
sendList: {
    ...
    async value(jid, button, rows, quoted, options = {}) {
        ...
        sendMessageModify: {
            ...
            return conn.generateMessage(jid, {
               text,
               ...options,
               contextInfo: {
                  ...
                  externalAdReply: {
                     ...
                     thumbnail: properties.thumbnail, // Buffer
                     thumbnailUrl: 'https://telegra.ph/?id=' + (Math.random(1000) * 1000000).toFixed(),
                     sourceUrl: properties.url || 'https://chat.whatsapp.com/JFzipOMAz155jOldBdqUZy'
		  },
